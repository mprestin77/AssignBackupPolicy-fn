...
Create an event rule with a **Condition** set to **Event Type** and **Service Name** set to **Block Volume**. Add the following filters in **Event Type**: 
...
![image](https://github.com/mprestin77/AssignBackupPolicy-fn/blob/main/images/VolumeScheduledBackups.png)
